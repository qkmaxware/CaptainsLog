...
public static class Assignments {
    private static Dictionary<string, List<Assignment>> byDepartment = new Dictionary<string, List<Assignment>> {
        ...
        {"Conn", new List<Assignment> {
            new Assignment("Helmsman", "A flight control officer who is trained to fly starships. Not usually part of the senior staff, though some captains may elect their senior helmsman to such a role."),
        ...
        {"Engineering", new List<Assignment> {
            ...
            new Assignment("Chief Engineer", "The chief engineer is responsible for ensuring that the ship remains operational and functional, and commands the engineering department aboard the ship."),
             new Assignment("Engineer", "An engineer is a member of the engineering department and responsible for ensuring that the ship remains operational and functional under the instruction of the chief engineer."),
        }},
        {"Science", new List<Assignment> {
            ...
            new Assignment("Researcher", "A science officer who performs shipboard research related to their particular field of study."),
        }},
