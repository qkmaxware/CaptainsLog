...
public class MissionBriefingGenerator {
    ...
    public MissionBriefingGenerator() {
        ...
        this.advantages.Add(new RandomPick<Advantage>(new List<Advantage>{ new Advantage("Surplus Components","")}));
        this.advantages.Add(new RandomPick<Advantage>(new List<Advantage>{ new Advantage("Surprise Discovery","")}));
        this.advantages.Add(new RandomPick<Advantage>(new List<Advantage>{ new Advantage("Remember Your Training","")}));
        this.advantages.Add(new RandomPick<Advantage>(new List<Advantage>{ new Advantage("Second Wind","")}));
        this.advantages.Add(new RandomPick<Advantage>(new List<Advantage>{ new Advantage("Helpful Species - Primitive","")}));
        this.advantages.Add(new RandomPick<Advantage>(new List<Advantage>{ new Advantage("Helpful Species - Contemporaries","")}));
        this.advantages.Add(new RandomPick<Advantage>(new List<Advantage>{ new Advantage("Helpful Species - Advanced","")}));
        this.advantages.Add(new RandomPick<Advantage>(new List<Advantage>{ new Advantage("An Ancient Discovery","")}));
        this.advantages.Add(new RandomPick<Advantage>(new List<Advantage>{ new Advantage("Federation Assistance","")}));
        this.advantages.Add(new RandomPick<Advantage>(new List<Advantage>{ new Advantage("Change of Heart","")}));
        this.advantages.Add(new RandomPick<Advantage>(new List<Advantage>{ new Advantage("Redundant Systems","")}));
        this.advantages.Add(new RandomPick<Advantage>(new List<Advantage>{ new Advantage("Lucky Circumstances","")}));
        this.advantages.Add(new RandomPick<Advantage>(new List<Advantage>{ new Advantage("Beneficial Element","")}));
        this.advantages.Add(new RandomPick<Advantage>(new List<Advantage>{ new Advantage("Inspiring Vista","")}));
        this.advantages.Add(new RandomPick<Advantage>(new List<Advantage>{ new Advantage("Historic Precedent","")}));
        this.advantages.Add(new RandomPick<Advantage>(new List<Advantage>{ new Advantage("Advanced Prototype","")}));
        this.advantages.Add(new RandomPick<Advantage>(new List<Advantage>{ new Advantage("Critical Evidence","")}));
        this.advantages.Add(new RandomPick<Advantage>(new List<Advantage>{ new Advantage("Power Surge","")}));
        this.advantages.Add(new RandomPick2<Advantage>(this.advantages));

        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("Total Catastrophe","")}));
        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("Inferior Equipment","")}));
        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("Random Failure","")}));
        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("Horrific Discovery","")}));
        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("Crisis of Conscience","")}));
        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("Unexpected Attack","")}));
        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("Disease Outbreak","")}));
        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("Environmental Danger","")}));
        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("Sudden Reversal","")}));
        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("Absolute Bedlam","")}));
        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("Conflicting Orders","")}));
        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("Shattered Chain of Command","")}));
        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("Infiltrator","")}));
        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("Mesmerized Crew","")}));
        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("Overworked Crew","")}));
        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("Diplomatic Incident","")}));
        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("Inept Crewmember","")}));
        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("Massive Casualties","")}));
        this.complications.Add(new RandomPick<Complication>(new List<Complication>{ new Complication("More Valuable Than Useful","")}));
